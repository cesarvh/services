...
public class UpdateObjectNationalitiesFromPersonBatchJob extends AbstractBatchJob {
    ...
    public InvocationResults updateNationalitiesFromPerson(String personCsid, Map<String, List> nationalitiesToUpdate) throws URISyntaxException, DocumentException, Exception {
        ...
        for (String csid : collectionObjectsList) {
            ...
            String oldNationalities = getFieldValue(collectionObjectPayload, "collectionobjects_bampfa", "nationalities");
            updateNationalities(oldNationalities, nationalitiesToUpdate, csid, inAuthority);
    ...
    public void updateNationalities(String collectionObjNationalities, Map<String, List> nationalitiesToUpdate, String objCsid, String authorityCsid) {
